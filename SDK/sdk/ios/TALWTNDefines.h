...
#define TALWTN_IOS_EXPORT __attribute__((visibility("default")))
...
typedef NS_ENUM(NSInteger, TALWTNPubAudioSource) {
    ...
    */
    TALWTNPubAudioSourceInternalRecord = 0,
   /** {zh}
    * @brief 推送的外部 PCM 数据
    */
   /** {en}
    ...
    */
    TALWTNPubAudioSourcePushExternalPCM = 1,
};
/** {zh}
 * @type keytype
 * @brief 发布的视频源类型
...
typedef NS_ENUM(NSInteger, TALWTNPubVideoSource) {
    ...
    */
    TALWTNPubVideoSourceInternalCamera = 0,
   /** {zh}
    * @brief 推送的外部 YUV 数据
    */
   /** {en}
    ...
    */
    TALWTNPubVideoSourcePushExternalYUV = 1,
   /** {zh}
    ...
    */
    TALWTNPubVideoSourcePushExternalH264 = 2,
};
/** {zh}
 * @type keytype
 * @brief 订阅的音频源类型
...
typedef NS_ENUM(NSInteger, TALWTNSubAudioSource) {
    ...
    */
    TALWTNSubAudioSourceInternalPlay = 0,
   /** {zh}
    * @brief PCM 音频数据。
    ...
    */
    TALWTNSubAudioSourceCallbackPCM = 1,
};
...
typedef NS_ENUM(NSInteger, TALWTNSubVideoSource) {
    ...
    */
    TALWTNSubVideoSourceInternalRender = 0,
   /** {zh}
    * @brief YUV 格式的视频数据。
    ...
    */
    TALWTNSubVideoSourceCallbackYUV = 1,
   /** {zh}
    ...
    */
    TALWTNSubVideoSourceCallbackH264 = 2,
};
...
typedef NS_ENUM(NSInteger, TALWTNReason) {
    ...
    */
    TALWTNReasonResourcesNotFound = 3,
   /** {zh}
    ...
    */
    TALWTNReasonServerInternalError = 4,
   /** {zh}
    ...
    */
    TALWTNReasonSDKInternalError = 5,
   /** {zh}
    * @brief 失败。网络错误。
    */
   /** {en}
 ...
 * @brief publish param
 */
TALWTN_IOS_EXPORT @interface TALWTNPubExtraParam : NSObject
/** {zh}
 * @brief 音频源发布
 */
/** {en}
 ...
 */
TALWTN_IOS_EXPORT @interface TALWTNSubExtraParam: NSObject
/** {zh}
 * @brief 音频源订阅。参看 TALWTNSubAudioSource{@link #TALWTNSubAudioSource}。
 */
/** {en}
 * @brief Subscribe audio source. See TALWTNSubAudioSource{@link #TALWTNSubAudioSource}.
 */
@property (nonatomic, assign) TALWTNSubAudioSource sub_audio_source;
/** {zh}
 * @brief 视频源订阅。参看 TALWTNSubVideoSource{@link #TALWTNSubVideoSource}。
 */
/** {en}
 * @brief Subscribe video source. See TALWTNSubVideoSource{@link #TALWTNSubVideoSource}.
 */
 ...
 */
TALWTN_IOS_EXPORT @interface TALWTNEncodedVideoFrame: NSObject
/** {zh}
 ...
 */
TALWTN_IOS_EXPORT @interface TALWTNVideoFrame: NSObject
/** {zh}
 ...
 * @brief Audio frame
 */
TALWTN_IOS_EXPORT @interface TALWTNAudioFrame: NSObject
/** {zh}
 ...
 * @brief Video config
 */
TALWTN_IOS_EXPORT @interface TALWTNVideoConfig: NSObject
/** {zh}
 ...
 */
TALWTN_IOS_EXPORT @interface TALWTNStallInfo: NSObject
/** {zh}
 * @brief 500 毫秒卡顿次数
 */
/** {en}
 ...
 * @brief Audio stats
 */
TALWTN_IOS_EXPORT @interface TALWTNRTCAudioStats: NSObject
/** {zh}
 * @brief 发送字节数，单位：字节。
 */
/** {en}
 ...
 * @brief Video stats
 */
TALWTN_IOS_EXPORT @interface TALWTNRTCVideoStats: NSObject
/** {zh}
 * @brief 发送字节数，单位字节
 */
/** {en}
