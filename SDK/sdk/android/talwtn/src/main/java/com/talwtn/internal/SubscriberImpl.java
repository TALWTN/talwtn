...
import com.talwtn.jni.NativeFunctions;
...
//        });
        ...
        new Handler(Looper.getMainLooper()).post(new Runnable() {
            ...
            public void run() {
                ...
                if(surfaceView instanceof SurfaceViewRenderer) {
                    ((SurfaceViewRenderer)surfaceView).release();
                    ((SurfaceViewRenderer)surfaceView).init(eglBase.getEglBaseContext(), null, EglBase.CONFIG_PLAIN,
                            new GlRectDrawer());
                }
                NativeFunctions.nativeSetRemoteView(nativeSubscriberPtr, surfaceView);
            }
        });
        return 0;
    }
