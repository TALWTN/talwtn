...
#include "com/talwtn/jni/NativeFunctions_jni.h"
#include "talwtn_jni_common.h"
...
static jlong JNI_NativeFunctions_CreatePublisher(JNIEnv *env, jlong nativePtr,
    ...
    talwtn::PubExtraParam pubExtraParam;
    pubExtraParam.pub_audio_source = (talwtn::PubAudioSource) pubAudioSource;
    pubExtraParam.pub_video_source = (talwtn::PubVideoSource) pubVideoSource;
    return webrtc::NativeToJavaPointer(
            reinterpret_cast<talwtn::IRtcEngine *>(nativePtr)->CreatePublisher(
                    pubExtraParam));
}
...
static void JNI_NativeFunctions_DestroyPublisher(JNIEnv *env, jlong nativePtr,
    ...
    JNI_CHECK_NULL_AND_RETURN(nativePtr);
    reinterpret_cast<talwtn::IRtcEngine *>(nativePtr)->DestroyPublisher(
            reinterpret_cast<talwtn::IPublisher *>(nativePublisherPtr));
}
...
static void JNI_NativeFunctions_SetVideoConfig(JNIEnv *env, jlong nativePublisherPtr,
    ...
    reinterpret_cast<talwtn::IPublisher *>(nativePublisherPtr)->SetVideoConfig(
            videoConfig);
}
...
static jint JNI_NativeFunctions_StartPublish(JNIEnv *env, jlong nativePublisherPtr,
    ...
    return reinterpret_cast<talwtn::IPublisher *>(nativePublisherPtr)->StartPublish(
            strUrl.c_str());
}

static jint JNI_NativeFunctions_StopPublish(JNIEnv *env, jlong nativePublisherPtr) {
    JNI_CHECK_NULL_AND_RETURN_ZERO(nativePublisherPtr);
    return reinterpret_cast<talwtn::IPublisher *>(nativePublisherPtr)->StopPublish();
}

static jint JNI_NativeFunctions_SetLocalAudioMute(JNIEnv *env, jlong nativePublisherPtr,
                                                  jboolean mute) {
    JNI_CHECK_NULL_AND_RETURN_ZERO(nativePublisherPtr);
    return reinterpret_cast<talwtn::IPublisher *>(nativePublisherPtr)->SetLocalAudioMute(
            mute);
}
...
static jint JNI_NativeFunctions_SetLocalVideoMute(JNIEnv *env, jlong nativePublisherPtr,
                                                  jboolean mute) {
    JNI_CHECK_NULL_AND_RETURN_ZERO(nativePublisherPtr);
    return reinterpret_cast<talwtn::IPublisher *>(nativePublisherPtr)->SetLocalVideoMute(
            mute);
}
...
JNI_NativeFunctions_PushEncodedVideoFrame(JNIEnv *env, jlong nativePublisherPtr,
    ...
    talwtn::EncodedVideoFrame encodedFrame;
    encodedFrame.codec_type = (talwtn::EncodedVideoFrameType) codec_type;
    ...
    jboolean ret = reinterpret_cast<talwtn::IPublisher *>(nativePublisherPtr)->PushEncodedVideoFrame(
            encodedFrame);
...
static jboolean JNI_NativeFunctions_PushVideoFrame(JNIEnv *env, jlong nativePublisherPtr,
    ...
    talwtn::VideoFrame videoFrame;
    videoFrame.type = (talwtn::VideoFrameType) type;
    ...
    jboolean ret = reinterpret_cast<talwtn::IPublisher *>(nativePublisherPtr)->PushVideoFrame(
            videoFrame);
...
static jboolean JNI_NativeFunctions_PushAudioFrame(JNIEnv *env, jlong nativePublisherPtr,
                                                   ...
                                                   jint channels) {
    jbyte *bytes = env->GetByteArrayElements(data.obj(), 0);
    talwtn::AudioFrame audioFrame;
    audioFrame.type = (talwtn::AudioFrameType) type;
    ...
    jboolean ret = reinterpret_cast<talwtn::IPublisher *>(nativePublisherPtr)->PushAudioFrame(
            audioFrame);
    env->ReleaseByteArrayElements(data.obj(), bytes, 0);
    return ret;
}
...
static jlong JNI_NativeFunctions_CreateSubscriber(JNIEnv *env, jlong nativePtr,
                                                  jint subAudioSource,
                                                  jint subVideoSource) {
    talwtn::SubExtraParam subExtraParam;
    subExtraParam.sub_audio_source = (talwtn::SubAudioSource) subAudioSource;
    subExtraParam.sub_video_source = (talwtn::SubVideoSource) subVideoSource;
    return webrtc::NativeToJavaPointer(
            reinterpret_cast<talwtn::IRtcEngine *>(nativePtr)->CreateSubscriber(
                    subExtraParam));
}
...
static void JNI_NativeFunctions_DestroySubscriber(JNIEnv *env, jlong nativePtr,
    ...
    JNI_CHECK_NULL_AND_RETURN(nativePtr);
    reinterpret_cast<talwtn::IRtcEngine *>(nativePtr)->DestroySubscriber(
            reinterpret_cast<talwtn::ISubscriber *>(nativeSubscriberPtr));
}
...
static void JNI_NativeFunctions_SetRemoteView(JNIEnv *env, jlong nativeSubscriberPtr,
    ...
    reinterpret_cast<talwtn::ISubscriber *>(nativeSubscriberPtr)->SetRemoteView(
            env->NewGlobalRef(remoteSink.obj()));
}

static void JNI_NativeFunctions_SetEnableSpeaker(JNIEnv *env, jlong nativeSubscriberPtr,
                                                 jboolean enable) {
    reinterpret_cast<talwtn::ISubscriber *>(nativeSubscriberPtr)->SetEnableSpeaker(
            enable);
}

static jboolean JNI_NativeFunctions_IsSubscribed(JNIEnv *env, jlong nativeSubscriberPtr) {
    return reinterpret_cast<talwtn::ISubscriber *>(nativeSubscriberPtr)->IsSubscribed();
}
...
static jint JNI_NativeFunctions_StartSubscribe(JNIEnv *env, jlong nativeSubscriberPtr,
    ...
    std::string strUrl = webrtc::JavaToNativeString(env, url);
    return reinterpret_cast<talwtn::ISubscriber *>(nativeSubscriberPtr)->StartSubscribe(
            strUrl.c_str());
}

static jint JNI_NativeFunctions_StopSubscribe(JNIEnv *env, jlong nativeSubscriberPtr) {
    JNI_CHECK_NULL_AND_RETURN_ZERO(nativeSubscriberPtr);
    return reinterpret_cast<talwtn::ISubscriber *>(nativeSubscriberPtr)->StopSubscribe();
}

static jint JNI_NativeFunctions_SetRemoteAudioMute(JNIEnv *env, jlong nativeSubscriberPtr,
                                                   jboolean mute) {
    JNI_CHECK_NULL_AND_RETURN_ZERO(nativeSubscriberPtr);
    return reinterpret_cast<talwtn::ISubscriber *>(nativeSubscriberPtr)->SetRemoteAudioMute(
            mute);
}
...
static jint JNI_NativeFunctions_SetRemoteVideoMute(JNIEnv *env, jlong nativeSubscriberPtr,
                                                   jboolean mute) {
    JNI_CHECK_NULL_AND_RETURN_ZERO(nativeSubscriberPtr);
    return reinterpret_cast<talwtn::ISubscriber *>(nativeSubscriberPtr)->SetRemoteVideoMute(
            mute);
}
