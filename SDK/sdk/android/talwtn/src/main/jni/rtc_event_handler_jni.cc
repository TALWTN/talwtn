...
#include <com/talwtn/internal/InternalRtcAudioStats_jni.h>
#include <com/talwtn/internal/InternalRtcVideoStats_jni.h>
#include <com/talwtn/internal/InternalEncodedVideoFrame_jni.h>
#include <com/talwtn/internal/InternalVideoFrame_jni.h>
#include <com/talwtn/internal/InternalAudioFrame_jni.h>
#include <com/talwtn/internal/InternalStallInfo_jni.h>
#include "rtc_event_handler_jni.h"
#include "sdk/android/native_api/jni/jvm.h"
#include "sdk/android/native_api/jni/scoped_java_ref.h"
#include "talwtn_jni_common.h"
#include "com/talwtn/internal/RtcEventHandlerImpl_jni.h"
...
void
RtcEventHandler::OnPublishStateChanged(const char *stream_id, talwtn::State state,
                                       talwtn::Reason reason) {
...
void
RtcEventHandler::OnLocalStats(const char *stream_id, talwtn::RTCAudioStats audio_stats,
                              talwtn::RTCVideoStats video_stats) {
    JNI_CHECK_JNI_OBJEC_IS_NULL_AND_RETURN(j_handler_);
    JNIEnv *env = AttachCurrentThreadIfNeeded();
...
void RtcEventHandler::OnMuteAudioFailed(const char *stream_id, talwtn::Reason reason) {
    JNI_CHECK_JNI_OBJEC_IS_NULL_AND_RETURN(j_handler_);
    JNIEnv *env = AttachCurrentThreadIfNeeded();
...
void RtcEventHandler::OnMuteVideoFailed(const char *stream_id, talwtn::Reason reason) {
    JNI_CHECK_JNI_OBJEC_IS_NULL_AND_RETURN(j_handler_);
    JNIEnv *env = AttachCurrentThreadIfNeeded();
...
void
RtcEventHandler::OnRemoteStats(const char *stream_id, talwtn::RTCAudioStats audio_stats,
                               talwtn::RTCVideoStats video_stats) {
    JNI_CHECK_JNI_OBJEC_IS_NULL_AND_RETURN(j_handler_);
    JNIEnv *env = AttachCurrentThreadIfNeeded();
...
void RtcEventHandler::OnStallInfo(const char *stream_id, talwtn::StallInfo stall_info) {
    JNI_CHECK_JNI_OBJEC_IS_NULL_AND_RETURN(j_handler_);
    JNIEnv *env = AttachCurrentThreadIfNeeded();
