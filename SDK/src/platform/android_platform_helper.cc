...
void StartAndroidVideoCapturer(
    ...
    webrtc::ScopedJavaLocalRef<jclass> pc_factory_class = webrtc::GetClass(env, "com/talwtn/internal/PublisherImpl");
...
void SetAndroidEnableSpeaker(bool enable) {
    JNIEnv *env = webrtc::jni::GetEnv();
    webrtc::ScopedJavaLocalRef<jclass> pc_factory_class = webrtc::GetClass(env, "com/talwtn/internal/SubscriberImpl");
    jmethodID link_camera_method = webrtc::GetStaticMethodID(
