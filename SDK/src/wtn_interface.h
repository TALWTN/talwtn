...
#define TALWTN_API extern "C"
#else
#define TALWTN_API __attribute__((__visibility__("default"))) extern "C"
#endif
...
TALWTN_API void SetExtendedParameters(ExtendedParameters param);
TALWTN_API IRtcEngine* CreateRtcEngine(IRtcEventHandler* event_handler);
TALWTN_API void DestroyRtcEngine(const IRtcEngine* engine_ptr);
