...
set(PUB_HEADERS
        sdk/ios/TALWTNSubscriber.h
        sdk/ios/TALWTNPublisher.h
        sdk/ios/TALWTNEngine.h
        sdk/ios/TALWTNDefines.h
        )
set_target_properties(${TARGET_NAME} PROPERTIES
        FRAMEWORK TRUE
        FRAMEWORK_VERSION A
        PUBLIC_HEADER "${PUB_HEADERS}"
        MACOSX_FRAMEWORK_IDENTIFIER com.talwtn
        MACOSX_FRAMEWORK_INFO_PLIST ${TALWTN_ROOT_DIR}/sdk/ios/Info.plist
...
# set output name
set_target_properties(${TARGET_NAME} PROPERTIES OUTPUT_NAME "TalWTN")
...
target_include_directories(${TARGET_NAME} PRIVATE ${TALWTN_ROOT_DIR}/src/sdk/ios)

# interface symbol export
set_target_properties(${TARGET_NAME} PROPERTIES EXPORTED_SYMBOLS_FILE "${TALWTN_ROOT_DIR}/sdk/ios/export.txt")
