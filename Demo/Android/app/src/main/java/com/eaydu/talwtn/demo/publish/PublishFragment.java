...
import static com.eaydu.talwtn.demo.ui.CustomDialog.EXTRA_BUTTON;
...
import com.eaydu.talwtn.demo.Constants;
import com.eaydu.talwtn.demo.R;
import com.eaydu.talwtn.demo.bean.Configuration;
import com.eaydu.talwtn.demo.databinding.FragmentPublishBinding;
import com.eaydu.talwtn.demo.ui.CustomDialog;
import com.eaydu.talwtn.demo.ui.InnerToast;
import com.eaydu.talwtn.demo.utils.CommonConfig;
...
public class PublishFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.userId.setText(getString(R.string.id_prefix, "TalWTN"));
        // endregion
        ...
        viewModel.initPublisher(context, Constants.PUSH_STREAMID, binding.preview);
        ...
        viewModel.events.observe(getViewLifecycleOwner(), publishEvent -> {
            if (publishEvent.state == RtcDefines.State.StartSuccess) {
                ...
                if (publishEvent.reason == RtcDefines.Reason.TokenError) {
                    // Token 过期
                }
