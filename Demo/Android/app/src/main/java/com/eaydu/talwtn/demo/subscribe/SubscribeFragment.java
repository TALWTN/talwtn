...
import com.eaydu.talwtn.demo.databinding.FragmentSubscribeBinding;
import com.eaydu.talwtn.demo.ui.CustomDialog;
import com.eaydu.talwtn.demo.ui.InnerToast;
import com.eaydu.talwtn.demo.utils.IMEUtils;
...
public class SubscribeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel.initSubscribe(requireContext(), Constants.PULL_STREAMID, binding.preview);
        ...
        viewModel.events.observe(getViewLifecycleOwner(), event -> {
            if (event.state == RtcDefines.State.StartFailed) {
            ...
            } else if (event.state == RtcDefines.State.StartSuccess) {
                binding.resolveLinkProgress.setVisibility(View.GONE);
